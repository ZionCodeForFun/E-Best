...
const CustomSelectAccess = ({ options, placeholder, value, onChange }) => {
          ...
          <ul className="custom-select-options">
            {filteredOptions.length > 0 ? (
              ...
              <li className="custom-select-no-option">
                ...
                <a
                  href={`https://wa.me/+2348133369509?text=Hello, I would like to request accessory: ${encodeURIComponent(
                    search,
                  )}`}
                  target="_blank"
                ...
                >
                  Request this accessory on WhatsApp
                </a>
              </li>
            )}
          </ul>
...
export default CustomSelectAccess;
